...
tf_idf_vector = TfidfVectorizer(ngram_range=(1, 1), binary=False, use_idf=True, norm=None, max_features=200)
...
mean_accuracy = cross_val_score(LR_model, X_train, Y_train, scoring='accuracy', cv=10).mean()
